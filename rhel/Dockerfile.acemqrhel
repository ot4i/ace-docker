...
ENV SUMMARY="Integration Server with MQ for IBM App Connect Enterprise on ICP" \
    DESCRIPTION="Integration Server with MQ for IBM App Connect Enterprise on ICP" \
...
LABEL summary="$SUMMARY" \
      ...
      io.k8s.display-name="Integration Server with MQ for IBM App Connect Enterprise on ICP" \
...
RUN useradd -d /home/aceuser -G mqbrkrs,wheel,mqm aceuser \
